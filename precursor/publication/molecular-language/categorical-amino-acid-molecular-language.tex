...
% Include sections
\input{sections/amino-acid-sequence-transformation}
\input{sections/molecular-language-grammar}
\input{sections/fragment-graph-nodes}
\input{sections/categorical-empty-dictionary}
\input{sections/sequence-reconstruction}
