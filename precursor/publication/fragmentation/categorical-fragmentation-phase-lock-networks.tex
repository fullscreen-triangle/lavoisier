...
Section~\ref{sec:partition-theory} establishes the partition theory foundation demonstrating the triple equivalence of oscillation, category, and partition. Section~\ref{sec:fragment_states} develops the categorical state framework for fragments. Section~\ref{sec:sentropy} presents S-entropy feature extraction adapted for fragmentation spectra. Section~\ref{sec:platform} validates platform independence. Section~\ref{sec:conclusions} discusses implications for computational metabolomics.

% Import sections
\input{sections/partition-theory-foundation}
