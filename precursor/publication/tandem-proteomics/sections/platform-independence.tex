...
Platform independence validation employed quad-platform comparison: Waters Synapt G2-Si (Q-TOF with ion mobility), Thermo Orbitrap Fusion Lumos (Orbitrap-quadrupole hybrid), Sciex TripleTOF 6600 (Q-TOF), and Bruker timsTOF Pro (TIMS-TOF with trapped ion mobility).
...
Modest intensity correlations ($r \approx 0.5-0.6$) and high coefficient of variation (CV $\approx 40\%$) indicate platform-specific fragmentation patterns prevent direct intensity-based cross-platform matching.
...
For same-peptide cross-platform comparison using 14D S-entropy feature space:
