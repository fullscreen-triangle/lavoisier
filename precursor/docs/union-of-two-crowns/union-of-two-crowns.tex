...
\title{\textbf{The Union of Two Crowns: Experimental Validation of Quantum-Classical Equivalence Through Interchangeable Explanations in Mass Spectrometry}}
...
\input{sections/fundamental-equivalence}
%==============================================================================
\section{Fundamental Axioms}
\label{sec:fundamental-axioms}
\input{sections/fundamental-axioms}
%==============================================================================
\section{Periodic Table}
\label{sec:periodic-table}
\input{sections/periodic-table}
%==============================================================================
\section{Gas Dynamics}
\label{sec:gas-dynamics}
\input{sections/gas-dynamics}
%==============================================================================
\section{Newtonian Mechanics}
\label{sec:newtonian-mechanics}
\input{sections/newtonian-mechanics}
%==============================================================================
