...
% Import sections
\input{categorical-mechanics}
\input{pixel-maxwell-demon}

\input{dual-membrane-system}
\input{electric-circuit-complementarity}
\input{harmonic-coincidence-networks}
\input{image-processing-methods}
