...
class StStellasMolecularLanguage:
    ...
    def __init__(self):
        ...
        self.encoding_layers = {
            'word_expansion': self._word_expansion_layer,
            'positional_context': self._positional_context_layer,
            'directional_transformation': self._directional_transformation_layer,
            'ambiguous_compression': self._ambiguous_compression_layer
        }
