...
% --- Number sets (from source papers) -----------------------
\newcommand{\Real}{\mathbb{R}}
\newcommand{\Natural}{\mathbb{N}}
\newcommand{\Integer}{\mathbb{Z}}

% --- Additional field / space symbols -----------------------
\newcommand{\Sspace}{\mathcal{S}}           % partition structure set
\newcommand{\Potential}{\mathcal{V}}        % unrealised partition potential

% --- Interpretation environment (unnumbered) ----------------
