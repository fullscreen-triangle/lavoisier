...
\titleformat{\chapter}[display]
  ...
  {1ex}
  {\titlerule[0.8pt]\vspace{1ex}\filright #1}
  [\vspace{1ex}\titlerule[0.4pt]]
...
\usepackage[colorlinks=true,
            ...
            pdftitle={Union of Two Crowns}]{hyperref}
\usepackage{cleveref}
...
\newcommand{\Residue}{\mathcal{R}}          % unactualised residue
...
\begin{titlepage}
  ...
  \begin{flushright}
    ...
    {\large\itshape A Monograph on Bounded Phase Space\\
     and Mass Spectrometric Observation}
    \vfill
...
\input{chapters/ch01-ion-journey}
...
\label{ch:sentropy}
\input{chapters/ch13-sentropy}

\chapter{The Floor Theorem}
\label{ch:floor}
\input{chapters/ch14-floor}

\chapter{Triple Equivalence}
\label{ch:triple}
\input{chapters/ch15-triple}
...
\label{ch:inflation}
\input{chapters/ch19-inflation}

\chapter{Gravity, Dark Matter, and Dark Energy}
\label{ch:gravity}
\input{chapters/ch20-gravity}
...
\input{chapters/ch25-predictions}
