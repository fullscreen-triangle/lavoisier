...
export default function Mass({ ActiveIndex }) {
  ...
  useEffect(() => {
    ...
    // Generate mass accumulation data: m ~ alpha * integral |N(t)| dt
    const numPoints = 50
    const alpha = 0.8
    const data = Array.from({ length: numPoints }, (_, i) => {
      const t = (i / (numPoints - 1)) * 100
      // Non-actualisations accumulate logarithmically
    ...
    const y = d3.scaleLinear()
      .domain([0, d3.max(data, d => d.mass) * 1.1])
      .range([innerHeight, 0])
  ...
  useEffect(() => {
    ...
    labels.forEach((label, i) => {
      ...
      svg.append('rect')
        ...
        .attr('rx', 8)
        .attr('ry', 8)
        .attr('fill', 'rgba(153, 128, 250, 0.1)')
        .attr('stroke', '#9980FA')
          ...
          <div className="section-grid">
            ...
            <div className="content-column">
              <div className="section-header">
                <span className="section-label">Mass</span>
                <h2>Mass = Memory</h2>
                <p>
              ...
              <div className="stat-row">
                ...
                <div className="stat-item">
                  <span className="stat-value">m<sub>i</sub> = m<sub>g</sub></span>
                  <span className="stat-label">Equivalence (Theorem)</span>
                </div>
              </div>
