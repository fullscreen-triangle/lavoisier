...
{\LARGE\bfseries S-Entropy: A Novel Information-Theoretic Framework for\\
High-Dimensional Feature Extraction in Tandem Mass Spectrometry Proteomics}

\vspace{2cm}

{\large
Author Name$^{1,*}$, Co-Author Name$^{2}$, Senior Author Name$^{1,3}$
}

\vspace{1cm}

{\normalsize
$^{1}$Department of Computational Biology, University Name\\
$^{2}$Institute of Proteomics Research, Institution Name\\
$^{3}$Center for Systems Biology, University Name\\
}
